...
--FECHA: 30/05/2026
--DESCRIPCIÓN: Carga inicial para la base de datos, incluye la generación de 9 centros, 20 empleados, 20 clientes, 
--             al menos una máscota para cada cliente, al menos una estancia para cada mascota, 10 ventas físicas 
--			   y 10 ventas en línea, y consultas de veterinario.
