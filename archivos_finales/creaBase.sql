...
CREATE TABLE CARRITO_FISICO(
    ...
    REFERENCES FISICA(VENTA_ID) ON DELETE CASCADE,
...
CREATE TABLE CARRITO_LINEA(
    ...
    REFERENCES LINEA(VENTA_ID) ON DELETE CASCADE,
...
CREATE TABLE BRAZALETE(
	...
	REFERENCES MASCOTA(MASCOTA_ID) ON DELETE CASCADE
)
go
...
CREATE TABLE HISTORICO_ESTANCIA(
    ...
    REFERENCES ESTANCIA(ID_ESTANCIA)  ON DELETE CASCADE
)
go
...
CREATE TABLE INV_MED_CONSULTA(
    ...
    REFERENCES CONSULTA(CONSULTA_ID) ON DELETE CASCADE,
