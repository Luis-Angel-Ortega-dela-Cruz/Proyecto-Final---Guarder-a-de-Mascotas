...
--TRIGGER 5
--Actualiza la comision de una venta física y suma dicha comision al sueldo del encargado de la tienda que hizo la venta.
...
begin
    ...
    insert into HISTORICO_ESTANCIA(HISTRICIO_ESTANCIA_ID, COSTO, CENTRO_ID, MASCOTA_ID, ID_CUIDADOR, ESTACION_ID, FECHA_INICIO, FECHA_FIN, DIAS_ESTANCIA, ID_ESTANCIA)
    select 
